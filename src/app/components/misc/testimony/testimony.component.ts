...
export class TestimonyComponent implements OnInit {
  testimonies = [
    {name: 'Grace Thato Ndumiso', content: 'Thanks to SHIBA TOKEN MINER, I invest and I made my profit successful'},
    {name: 'Velisphomiya', content: 'This Brooker is really legit, I invested and got my profit without stress'},
    {name: 'Darmain Grayson', content: `SHIBA TOKEN MINER as really change my financial
    ...
    {name: 'Hagos Trip', content: `I'm really happy today the website as change my
        financial life, you should try it and do not doubt I've gain alot profit, thanks to SHIBA TOKEN MINER`},
